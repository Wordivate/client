...
export default function PlayerGame() {
  ...
  if (grading) {
    return (
      <div className="player-grading" style={{ textAlign: "center", padding: "2rem" }}>
  ...
  if (!question) {
    return (
      <div className="player-game" style={{ textAlign: "center", padding: "2rem" }}>
        <h2>Menunggu soal...</h2>
      </div>
    );
  }
  ...
  return (
    <div className="player-game" style={{ maxWidth: "500px", margin: "2rem auto", padding: "1rem", textAlign: "center" }}>
      <div className="question-counter" style={{ color: "#666", marginBottom: "1rem" }}>
